...
- [ ] **Fas 4: Integrerad UX & Universell QR-kod (`inbjudningar`)**
  ...
  - [x] Skapa universell landningssida via QR/Länk med automatisk språkkontroll (Klarlagd/integrerad mot externt projekt: [utby-translate](https://github.com/bjud-in-oss/utby-translate) / [utby-translate.netlify.app](https://utby-translate.netlify.app)).
