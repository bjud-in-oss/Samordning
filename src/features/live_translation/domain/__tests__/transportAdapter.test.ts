...
describe("AudioTransportAdapter Contract & CloudflareSFUAdapter", () => {
  ...
  beforeEach(() => {
    ...
    (window as unknown as Record<string, unknown>).RTCPeerConnection = MockRTCPeerConnection;
    (window as unknown as Record<string, unknown>).RTCSessionDescription = MockRTCSessionDescription;
