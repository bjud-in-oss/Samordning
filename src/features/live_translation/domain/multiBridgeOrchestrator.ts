import { TranslationBridge, TokenProvider } from "./translationBridge";
...
export class MultiBridgeOrchestrator {
  ...
  constructor(
    private readonly apiKeyOrProvider: string | TokenProvider,
  ...
  public startLanguage(lang: SupportedLanguage): void {
    ...
    const bridge = new TranslationBridge(
      ...
      this.tokenProvider || (typeof this.apiKeyOrProvider === "function" ? this.apiKeyOrProvider : undefined)
    );
