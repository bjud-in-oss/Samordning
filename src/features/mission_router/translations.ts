...
export const TRANSLATIONS: Record<UiLanguage, TranslationDict> = {
  sv: {
    ...
    onboardingIntro: "Välkommen till vår trygga digitala anslagstavla. Genom att ställa in dina val får du en diskret avisering (notis) direkt i din telefon eller dator så fort någon i församlingen delar en ny inbjudan eller aktivitet i något av dina valda områden. Du kan enkelt läsa detaljerna och tacka ja via en direkt SMS-djuplänk.",
    ...
    pushSubtitle: "För att få notiser i samma sekund som en ny inbjudan läggs upp behöver du godkänna aviseringar i webbläsaren.",
  ...
  en: {
    ...
    onboardingIntro: "Welcome to our secure ward bulletin board. By configuring your preferences, you receive a discrete notification directly on your device as soon as a ward member shares a new invitation or activity in your chosen areas. You can easily view the details and accept via a direct SMS deep-link.",
    ...
    pushSubtitle: "To receive notifications the very second a new invitation is posted, you need to approve notifications in your browser.",
  ...
  es: {
    ...
    onboardingIntro: "Bienvenido a nuestro tablón de anuncios seguro de la congregación. Al configurar tus preferencias, recibes una notificación discreta directamente en tu dispositivo tan pronto como un miembro comparta una nueva invitación o actividad en las áreas seleccionadas. Puedes ver los detalles fácilmente y aceptar mediante un enlace directo de SMS.",
    ...
    pushSubtitle: "Para recibir notificaciones en el mismo segundo en que se publica una nueva invitación, debes aprobar las notificaciones en el navegador.",
  ...
  sw: {
    ...
    onboardingIntro: "Karibu kwenye ubao wetu salama wa matangazo wa ushirika. Kwa kuweka mapendeleo yako, utapokea arifa ya siri moja kwa moja kwenye kifaa chako mara tu mshiriki anaposhiriki mwaliko mpya au shughuli katika maeneo uliyochagua. Unaweza kuona maelezo kwa urahisi na kukubali kupitia SMS.",
    ...
    step2OrgText: "Hapa unaweza kuona mialiko ya wazi kutoka kwa Muungano wa Usaidizi wa Kina Mama (Relief Society), Akidi ya Wazee (Elders Quorum), na wamisionari vijana. Kila kitu kinakusanywa kwenye ubao mmoja wa matangazo kwa ufikiaji rahisi.",
    ...
    notifyOptionDesc: "Utapokea ujumbe mzuri wa wakati halisi wakati mwaliko mpya unapoundwa katika maeneo yako yanayofuatiliwa. Unajiamulia kwa uhuru ikiwa unataka kukubali.",
    ...
    iosTipBody: "Huduma hii inafanya kazi vizuri zaidi ikiwa imesakinishwa kwenye simu yako ya mkononi. Ikiwa unatumia iPhone, kwanza gusa kitufe cha Shiriki (mraba wenye mshale wa juu) katika Safari na uchague \"Ongeza kwenye Skrini ya Nyumbani\". Kisha fungua programu kutoka hapo ili kuwezesha arifa za moja kwa moja.",
    pushHeader: "Washa arifa",
    pushSubtitle: "Ili kupokea arifa sekunde ile ile mwaliko mpya unapoandikwa, unahitaji kuidhinisha arifa kwenye kivinjari chako.",
    ...
    successDeliveredDesc: "Kiungo cha SMS kinafungua SMS yako iliyoandaliwa tayari kwenda kwa mratibu.",
    ...
    languageLabel: "Lugha",
    privacyNotice: "Ulinzi av Faragha: Ili kulinda faragha ya wanachama na waandalizi kwa mujibu wa Mwongozo Mkuu 33.8, hakuna anwani halisi za nyumbani zinazoonyeshwa kwenye maandishi. Eneo limefichwa kwenye ramani kwa ujumla wake.",
  ...
  vi: {
    ...
    onboardingIntro: "Chào mừng bạn đến với bảng thông tin hội thánh an toàn của chúng tôi. Bằng cách thiết lập tùy chọn của mình, bạn sẽ nhận được một thông báo kín đáo trực tiếp trên thiết bị của mình ngay khi một thành viên hội thánh chia sẻ lời mời hoặc hoạt động mới trong các khu vực bạn đã chọn. Bạn có thể dễ dàng xem chi tiết và chấp nhận qua SMS.",
    ...
    pushSubtitle: "Để nhận thông báo ngay khi lời mời mới được đăng, bạn cần phê duyệt nhận thông báo trên trình duyệt của mình.",
